...
f01006fa:	68 61 18 10 00       	push   $0x101861
f01006ff:	68 61 18 10 f0       	push   $0xf0101861
...
f0100c22:	e8 b9 09 00 00       	call   f01015e0 <__udivdi3>
...
f0100c65:	e8 a6 0a 00 00       	call   f0101710 <__umoddi3>
...
f01014e8:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	const void *ends = (const char *) s + n;
f01014eb:	89 c2                	mov    %eax,%edx
f01014ed:	03 55 10             	add    0x10(%ebp),%edx
	for (; s < ends; s++)
f01014f0:	eb 07                	jmp    f01014f9 <memfind+0x17>
		if (*(const unsigned char *) s == (unsigned char) c)
f01014f2:	38 08                	cmp    %cl,(%eax)
f01014f4:	74 07                	je     f01014fd <memfind+0x1b>
...
f01014fb:	72 f5                	jb     f01014f2 <memfind+0x10>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
f0101502:	57                   	push   %edi
f0101503:	56                   	push   %esi
f0101504:	53                   	push   %ebx
f0101505:	8b 4d 08             	mov    0x8(%ebp),%ecx
f0101508:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int neg = 0;
	long val = 0;

	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f010150b:	eb 03                	jmp    f0101510 <strtol+0x11>
		s++;
f010150d:	83 c1 01             	add    $0x1,%ecx
{
	...
	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
f0101510:	0f b6 01             	movzbl (%ecx),%eax
f0101513:	3c 20                	cmp    $0x20,%al
f0101515:	74 f6                	je     f010150d <strtol+0xe>
f0101517:	3c 09                	cmp    $0x9,%al
f0101519:	74 f2                	je     f010150d <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
f010151b:	3c 2b                	cmp    $0x2b,%al
f010151d:	75 0a                	jne    f0101529 <strtol+0x2a>
		s++;
f010151f:	83 c1 01             	add    $0x1,%ecx
}
...
{
	int neg = 0;
f0101522:	bf 00 00 00 00       	mov    $0x0,%edi
f0101527:	eb 11                	jmp    f010153a <strtol+0x3b>
f0101529:	bf 00 00 00 00       	mov    $0x0,%edi
		s++;
...
f010152e:	3c 2d                	cmp    $0x2d,%al
f0101530:	75 08                	jne    f010153a <strtol+0x3b>
		s++, neg = 1;
f0101532:	83 c1 01             	add    $0x1,%ecx
f0101535:	bf 01 00 00 00       	mov    $0x1,%edi

	// hex or octal base prefix
	if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
f010153a:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
f0101540:	75 15                	jne    f0101557 <strtol+0x58>
f0101542:	80 39 30             	cmpb   $0x30,(%ecx)
f0101545:	75 10                	jne    f0101557 <strtol+0x58>
f0101547:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
f010154b:	75 7c                	jne    f01015c9 <strtol+0xca>
		s += 2, base = 16;
f010154d:	83 c1 02             	add    $0x2,%ecx
f0101550:	bb 10 00 00 00       	mov    $0x10,%ebx
f0101555:	eb 16                	jmp    f010156d <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
f0101557:	85 db                	test   %ebx,%ebx
f0101559:	75 12                	jne    f010156d <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
f010155b:	bb 0a 00 00 00       	mov    $0xa,%ebx
		s++, neg = 1;
...
f0101560:	80 39 30             	cmpb   $0x30,(%ecx)
f0101563:	75 08                	jne    f010156d <strtol+0x6e>
		s++, base = 8;
f0101565:	83 c1 01             	add    $0x1,%ecx
f0101568:	bb 08 00 00 00       	mov    $0x8,%ebx
	else if (base == 0)
		base = 10;
f010156d:	b8 00 00 00 00       	mov    $0x0,%eax
f0101572:	89 5d 10             	mov    %ebx,0x10(%ebp)
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
f0101575:	0f b6 11             	movzbl (%ecx),%edx
f0101578:	8d 72 d0             	lea    -0x30(%edx),%esi
f010157b:	89 f3                	mov    %esi,%ebx
f010157d:	80 fb 09             	cmp    $0x9,%bl
f0101580:	77 08                	ja     f010158a <strtol+0x8b>
			dig = *s - '0';
f0101582:	0f be d2             	movsbl %dl,%edx
f0101585:	83 ea 30             	sub    $0x30,%edx
f0101588:	eb 22                	jmp    f01015ac <strtol+0xad>
		else if (*s >= 'a' && *s <= 'z')
f010158a:	8d 72 9f             	lea    -0x61(%edx),%esi
f010158d:	89 f3                	mov    %esi,%ebx
f010158f:	80 fb 19             	cmp    $0x19,%bl
f0101592:	77 08                	ja     f010159c <strtol+0x9d>
			dig = *s - 'a' + 10;
f0101594:	0f be d2             	movsbl %dl,%edx
f0101597:	83 ea 57             	sub    $0x57,%edx
f010159a:	eb 10                	jmp    f01015ac <strtol+0xad>
		else if (*s >= 'A' && *s <= 'Z')
f010159c:	8d 72 bf             	lea    -0x41(%edx),%esi
f010159f:	89 f3                	mov    %esi,%ebx
f01015a1:	80 fb 19             	cmp    $0x19,%bl
f01015a4:	77 16                	ja     f01015bc <strtol+0xbd>
			dig = *s - 'A' + 10;
f01015a6:	0f be d2             	movsbl %dl,%edx
f01015a9:	83 ea 37             	sub    $0x37,%edx
		else
			break;
		if (dig >= base)
f01015ac:	3b 55 10             	cmp    0x10(%ebp),%edx
f01015af:	7d 0b                	jge    f01015bc <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
f01015b1:	83 c1 01             	add    $0x1,%ecx
f01015b4:	0f af 45 10          	imul   0x10(%ebp),%eax
f01015b8:	01 d0                	add    %edx,%eax
		// we don't properly detect overflow!
	}
f01015ba:	eb b9                	jmp    f0101575 <strtol+0x76>

	if (endptr)
f01015bc:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
f01015c0:	74 0d                	je     f01015cf <strtol+0xd0>
		*endptr = (char *) s;
f01015c2:	8b 75 0c             	mov    0xc(%ebp),%esi
f01015c5:	89 0e                	mov    %ecx,(%esi)
f01015c7:	eb 06                	jmp    f01015cf <strtol+0xd0>
		s++, neg = 1;
...
f01015c9:	85 db                	test   %ebx,%ebx
f01015cb:	74 98                	je     f0101565 <strtol+0x66>
f01015cd:	eb 9e                	jmp    f010156d <strtol+0x6e>
		// we don't properly detect overflow!
	}
	...
	if (endptr)
		*endptr = (char *) s;
	return (neg ? -val : val);
f01015cf:	89 c2                	mov    %eax,%edx
f01015d1:	f7 da                	neg    %edx
f01015d3:	85 ff                	test   %edi,%edi
f01015d5:	0f 45 c2             	cmovne %edx,%eax
}
f01015d8:	5b                   	pop    %ebx
f01015d9:	5e                   	pop    %esi
f01015da:	5f                   	pop    %edi
